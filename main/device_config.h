...
static const uint16_t MC3_FREQUENCY_OPTIONS[]     = {100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000};
...
static const uint16_t MC3_VOLTAGE_OPTIONS[]   = {960,  970,  980,  990, 1000, 1050, 1100, 1150, 1200};
...
static const AsicConfig ASIC_MC3    = { .id = MC3,    .name = "MC3",    .chip_id = 0,    .default_frequency_mhz = 400, .frequency_options = MC3_FREQUENCY_OPTIONS,    .default_voltage_mv = 1000, .voltage_options = MC3_VOLTAGE_OPTIONS,    .difficulty = 256, .core_count = 156, .small_core_count = 1248, .hash_domains = 4, .hashrate_test_percentage_target = 0.85, .default_asic_timeout = 500};
...
static const FamilyConfig FAMILY_PROTO       = { .id = PROTO,       .name = "Proto",      .asic = ASIC_MC3,      .asic_count = 4, .max_power =  40, .power_offset = 5,  .nominal_voltage = 12, .voltage_domains = 2, .swarm_color = "yellow",   };
